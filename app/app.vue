  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        operatingSystem: "Web",
        description:
          "Aplicação web simples para catálogo e listagem de profissionais de tecnologia, com visualização de detalhes individuais, habilidades, senioridade e localização.",
        inLanguage: "pt-BR",
        creator: {
          "@type": "Person",
          name: "Larissa Santos",
